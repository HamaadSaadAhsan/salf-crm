...
export class WorkflowHelpers {
     ...
     */
    static updateFacebookConfig(workflow: Workflow, pageId: string, formId: string, pageName?: string, formName?: string): Workflow {
        return {
            ...workflow,
     ...
     */
    static updateWebhookConfig(workflow: Workflow, url: string, method: string = 'POST', headers?: Record<string, string>): Workflow {
        return {
            ...workflow,
            steps: workflow.steps.map((step) => {
