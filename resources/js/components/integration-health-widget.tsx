...
import { Activity, AlertCircle, AlertTriangle, CheckCircle, Clock, RefreshCw, Users, XCircle, Zap } from 'lucide-react';
        ...
        <Card className="border-gray-800 bg-gray-900">
            ...
            <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <Badge className={getStatusColor(connectionStatus)}>{connectionStatus.charAt(0).toUpperCase() + connectionStatus.slice(1)}</Badge>
                </div>
                ...
                {isSuperAdmin && tokenStatus && (
                    <div className="space-y-2 border-t border-gray-700 pt-4">
                        <div className="flex items-center gap-2">
                            ...
                            <Badge className={getHealthBadgeColor(tokenStatus.overall_health)}>{tokenStatus.overall_health}</Badge>
                        </div>
                        ...
                        {(tokenStatus.expired_users.length > 0 || tokenStatus.expiring_soon_users.length > 0) && (
                            <div className="rounded-lg border border-orange-500/20 bg-orange-500/10 p-2">
                                ...
                                {tokenStatus.expiring_soon_users.length > 0 && (
                                    <div className="text-xs text-yellow-400">{tokenStatus.expiring_soon_users.length} expiring soon</div>
                                )}
                            </div>
                        )}
