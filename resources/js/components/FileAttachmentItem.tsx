...
import { FileIcon, FileText, ImageIcon, Pause, Play, Square, X } from 'lucide-react';
        ...
        <Popover open={isOpen} onOpenChange={setIsOpen}>
            <PopoverTrigger asChild>
                <div
                    ...
                    className="hover:bg-gray-750 flex cursor-pointer items-center gap-2 rounded-lg border border-gray-700 bg-gray-800 p-2 transition-colors"
                >
                    ...
                    <div className="min-w-0 flex-1">
                        <div className="flex items-center justify-between">
                            <span className="truncate text-sm text-white">{truncatedName}</span>
                            <Button
                                variant="ghost"
                                size="icon"
                                onClick={(e) => {
                                ...
                                className="h-4 w-4 rounded-sm p-0 text-gray-400 hover:bg-gray-600 hover:text-white"
                            >
                                <X className="h-3 w-3" />
                            </Button>
                        </div>
            ...
            <PopoverContent container={containerRef} side="top" className="w-80 border-gray-700 bg-gray-800 p-2">
                    ...
                    {file.file && file.type.startsWith('image/') && (
                        <div className="mt-2">
                            <img
                                ...
                                height={100}
                                alt={file.name}
                                className="h-28 w-full rounded border border-gray-600 object-contain"
                            />
                        </div>
                    )}
                    {file.status === 'uploading' && (
