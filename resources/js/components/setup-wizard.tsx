        ...
        <Card className="border-gray-800 bg-gray-900">
            ...
            <CardContent className="space-y-4">
                <div className="rounded-lg border border-blue-500/20 bg-blue-500/10 p-4">
                    <h4 className="mb-2 font-medium text-blue-400">What happens next?</h4>
                ...
                <Button className="w-full bg-blue-600 hover:bg-blue-700" onClick={initiateOAuth} disabled={isConnecting}>
                    {isConnecting ? (
                        <>
    ...
    const renderFeaturesStep = () => (
        <div className="space-y-4">
            <div className="mb-6 text-center">
                <h3 className="mb-2 text-xl font-semibold">Choose Your Features</h3>
                    ...
                    >
                        ...
                        <CardContent>
                            <div className="space-y-3">
                                <div>
                                    <h5 className="mb-1 text-sm font-medium">Benefits:</h5>
                                ...
                                <div>
                                    <h5 className="mb-1 text-sm font-medium">Required Permissions:</h5>
        ...
        <Card className="border-gray-800 bg-gray-900">
            ...
            <CardContent className="space-y-4">
                <div className="rounded-lg border border-green-500/20 bg-green-500/10 p-4">
                    <h4 className="mb-2 font-medium text-green-400">Ready to activate!</h4>
    ...
    return (
        <div className="mx-auto max-w-4xl space-y-6">
            ...
            <div className="flex justify-between">
                ...
                <Button onClick={handleNext} disabled={currentStep === 1 && selectedFeatures.length === 0} className="bg-blue-600 hover:bg-blue-700">
