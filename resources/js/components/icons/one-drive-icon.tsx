...
const GoogleDriveIcon = ({ className, ...props }: React.SVGProps<SVGSVGElement>) => {
    return (
        <svg width="800px" height="800px" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} {...props}>
            <mask
                id="mask0_87_7796"
                style={{ maskType: 'alpha' }} // Fixed: Style must be an object
            ...
            <defs>
                <linearGradient id="paint0_linear_87_7796" x1="4.42591" y1="24.6668" x2="27.2309" y2="23.2764" gradientUnits="userSpaceOnUse">
                    <stop stopColor="#2086B8" /> {/* Fixed: camelCase attributes */}
