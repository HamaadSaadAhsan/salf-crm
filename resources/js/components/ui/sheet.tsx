...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        'fixed inset-0 z-[100] bg-black/30 [backdrop-filter:blur(4px)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
        className,
      )}
      {...props}
    />
...
const sheetVariants = cva(
  'flex flex-col items-strech fixed z-[101] gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-400',
  {
    variants: {
      side: {
    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        onPointerDownOutside={(e) => {
          // Don't dismiss sheet when clicking inside a Sonner toast
          if (
