    ...
    return (
        <>
            ...
            <div className="flex min-h-screen flex-col items-center justify-center p-4">
                <Card className="h-full max-h-[616px] w-full max-w-md text-center">
                    <div className="flex items-center justify-center-safe gap-3 text-center">
                            ...
                            <Button className="w-full cursor-pointer">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_127_55)">
                                        <path
                                            d="M4.38832 8.23062C4.77823 7.10998 5.53071 6.13493 6.53842 5.44459C7.54613 4.75425 8.7576 4.38387 9.99999 4.38629C11.4083 4.38629 12.6817 4.86129 13.6817 5.63871L16.5917 2.875C14.8183 1.40646 12.5458 0.5 9.99999 0.5C6.05832 0.5 2.66499 2.63592 1.03333 5.76458L4.38832 8.23062Z"
                                            fill="#EA4335"
                                        />
                                        <path
                                            d="M13.3667 14.7603C12.4584 15.3168 11.3051 15.6137 10.0001 15.6137C8.76261 15.6161 7.55572 15.2487 6.55025 14.5634C5.54478 13.8782 4.79167 12.9099 4.39755 11.7955L1.03088 14.2235C1.85692 15.8119 3.13527 17.1483 4.72074 18.081C6.3062 19.0137 8.13522 19.5053 10.0001 19.5C12.4442 19.5 14.7792 18.6743 16.5284 17.125L13.3676 14.7603H13.3667Z"
                                            fill="#34A853"
                                        />
                                        <path
                                            d="M16.5283 17.125C18.3575 15.5037 19.545 13.0907 19.545 10C19.545 9.43792 19.4542 8.83388 19.3183 8.27258H10V11.9435H15.3633C15.0992 13.1778 14.3883 14.1333 13.3675 14.7603L16.5283 17.125Z"
                                            fill="#4A90E2"
                                        />
                                        <path
                                            d="M4.3976 11.7955C4.19373 11.2167 4.09016 10.6103 4.09093 10C4.09093 9.38092 4.1951 8.78638 4.38843 8.23063L1.03343 5.76458C0.347079 7.08088 -0.00673329 8.53108 9.70454e-05 10C9.70454e-05 11.52 0.37093 12.9529 1.03093 14.2235L4.3976 11.7955Z"
                                            fill="#FBBC05"
                                        />
                                    </g>
                                    <defs>
