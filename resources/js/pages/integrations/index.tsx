            ...
            <div className="flex min-h-screen flex-col bg-black p-6 text-white">
                <div className="mb-8 flex items-center justify-between">
                    ...
                    <div className="flex gap-4">
                        ...
                        <Button className="bg-white text-black hover:bg-gray-200">Create new</Button>
                    </div>
                </div>
                ...
                <div className="mb-6 flex items-center justify-between">
                    <Tabs defaultValue="all" onValueChange={(value) => setFilter(value as any)}>
                        <TabsList className="bg-gray-900">
                            ...
                            <TabsTrigger value="inactive" className="data-[state=active]:bg-gray-800">
                                Inactive
                            </TabsTrigger>
                        </TabsList>
                    </Tabs>
                    <div className="relative">
                        <Search className="absolute top-1/2 left-3 -translate-y-1/2 transform text-gray-500" size={18} />
                        <Input className="w-80 border-gray-800 bg-gray-900 pl-10 text-white" placeholder="Search" />
                    </div>
                </div>

                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {filteredIntegrations.map((integration) => (
                        <div key={integration.id} className="overflow-hidden rounded-lg bg-gray-900">
                                ...
                                <div className="flex items-start justify-between">
                                    <div className="flex items-center gap-4">
                                        <div className="flex h-12 w-12 items-center justify-center overflow-hidden">
                                            ...
                                            {integration.id === 'whatsapp' && <WhatsAppIcon />}
                            ...
                            <div className="flex items-center justify-between p-4">
                                {integration.setup && (
                                    <Link href={`/integrations/${integration.id}`}>
                                        <Button variant="ghost" className="flex items-center gap-2 text-sm text-gray-400 hover:text-white">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                width="24"
                                                height="24"
                                ...
                                {!integration.link ? (
                                    <Button
                                        ...
                                        variant="ghost"
                                        className="flex cursor-pointer items-center gap-2 text-sm text-gray-400 hover:text-white"
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="24"
                                ...
                                <Switch checked={integration.status === 'active'} onCheckedChange={() => toggleIntegrationStatus(integration.id)} />
                            </div>
                        </div>
                    ))}
                </div>
