                ...
                <div className="min-h-screen bg-background p-6 text-foreground">
                    <div className="mx-auto max-w-6xl">
                        <div className="mb-8 flex items-center gap-4">
                            ...
                            <h1 className="text-4xl font-bold text-balance text-foreground">Facebook Integration Templates</h1>
                        </div>
                ...
                <div className="min-h-screen bg-background p-6 text-foreground">
                    <div className="mx-auto max-w-6xl">
                        <div className="mb-8 flex items-center gap-4">
                            ...
                            <h1 className="text-4xl font-bold text-balance text-foreground">Facebook Integration Setup</h1>
                        </div>
        ...
        <AppLayout>
            <div className="min-h-screen bg-background p-6 text-foreground">
                <div className="mx-auto max-w-6xl space-y-6">
                    <div className="mb-8">
                        <h1 className="mb-4 text-4xl font-bold text-balance text-foreground">Facebook Integration</h1>
                        <p className="text-muted-foreground">Connect your Facebook account to sync leads, manage messages, and track performance.</p>
                    </div>
