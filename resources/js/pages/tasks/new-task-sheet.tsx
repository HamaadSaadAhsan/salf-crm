...
export function NewTaskSheet({ open, onOpenChange, users }: NewTaskSheetProps) {
                    ...
                    <ScrollArea className="h-[calc(90dvh-11.75rem)] ps-3 pe-2 me-1">
                        ...
                        <div className="space-y-2">
                            ...
                            <Select
                                ...
                                onValueChange={(value) =>
                                    setData({ ...data, assigned_to_id: value })
                                }
                            >
                                <SelectTrigger
                                    id="assigned_to"
                                    className={cn(errors.assigned_to_id && 'border-destructive focus:ring-destructive')}
                                >
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                <SelectTrigger
                                    id="priority"
                                    className={cn(errors.priority && 'border-destructive focus:ring-destructive')}
                                >
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
                        ...
                        <div className="space-y-2">
                            ...
                            >
                                <SelectTrigger
                                    id="status"
                                    className={cn(errors.status && 'border-destructive focus:ring-destructive')}
                                >
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent>
