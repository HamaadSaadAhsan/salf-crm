...
export function NotificationsSheet({ trigger }: { trigger: ReactNode }) {
  return (
    <Sheet>
      ...
      <SheetContent side="right" className="p-0 gap-0 sm:w-[500px] sm:max-w-none inset-5 start-auto h-auto rounded-lg sm:max-w-none [&_[data-slot=sheet-close]]:top-4.5 [&_[data-slot=sheet-close]]:end-5">
